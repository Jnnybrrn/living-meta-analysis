...
function extractReceivedMetaanalysis(receivedMetaanalysis) {
  ...
  const retval = {
    ...
    excludedExperiments: receivedMetaanalysis.excludedExperiments,
    // todo: Fix this
    // excludedExperiments: tools.assoc(receivedMetaanalysis.hiddenExperiments, extractReceivedExcludedExperiments),
